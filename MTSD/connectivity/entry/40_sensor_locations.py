...
'''
ten_twenty_montage = mne.channels.make_standard_montage('GSN-HydroCel-128')
...
'''
object_ten_twenty_montage = ten_twenty_montage.plot(kind='topomap', show_names=True)
'''
# object_ten_twenty_montage.savefig('/Users/linya/Desktop/research_files/midterm/ten_twenty_montage.jpg', dpi=450)
# %%
